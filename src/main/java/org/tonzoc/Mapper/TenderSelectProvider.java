...
public class TenderSelectProvider {
    private final String mainTable = "t";
    private final String tableName = "tenders t LEFT JOIN projects p ON t.projectId = p.id";
    private final String selects = "t.id, t.name, t.projectId, t.code, t.startSection, t.endSection, t.length, t.startDate, t.endDate, t.ownerCompany, t.contractCompany, t.contractTel, t.superviseCompany, t.superviseTel, t.testCompany, t.defaultApprovalDate, t.note, t.created_at, t.updated_at";

 ...
 */
public class CompanySelectProvider {
    private final String mainTable = "c";
    private final String tableName = "company c";
    private final String selects = "c.id, c.name, c.contact, c.tel, c.created_at, c.updated_at";
...
//        sb.append(selectParam.getPageSize());
    ...
    public String listByName(@Param("params") SelectParam selectParam) {
        StringBuilder sb = new StringBuilder(Utility.getSql1(mainTable, this.tableName, this.selects, selectParam.getWhereParams()));
